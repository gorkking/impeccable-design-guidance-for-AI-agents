...
export function buildClaudeSettingsManifest() {
  return {
    ...
    hooks: buildClaudeCompatibleHooks('Edit|Write|MultiEdit', CLAUDE_PROJECT_SCRIPTS),
  };
}
...
export function buildClaudePluginHooksManifest() {
  return {
    hooks: buildClaudeCompatibleHooks('Edit|Write|MultiEdit', CLAUDE_PLUGIN_SCRIPTS),
  };
}
